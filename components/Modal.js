...
const Modal = ({ isOpen, onClose, ModalText, functionCall = undefined }) => {
  return (
    <>
      {isOpen && (
        <div>
          <div id="popup-modal" className="fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full  h-full bg-black bg-opacity-50 border">
            <div className="relative p-4 w-full max-w-md">
              <div className="relative  bg-[#030712] text-white rounded-lg shadow border-solid border-4 border-[#9333ea] ">
                <button
                  type="button"
                  onClick={onClose}
                ...
                <div className="p-4 md:p-5 text-center">
                  ...
                  <h3 className="mb-5 text-lg font-normal text-white">{ModalText}</h3>
                  <button
