    ...
    <main className='h-full w-full md:px-14 px-5 '>
      ...
      <div className='grid md:grid-cols-4 gap-10 md:grid-rows-4 mt-2 md:mt-5'>
        <div className="border border-purple-500 rounded-lg md:px-5 md:py-6 px-8 py-12">
          ...
          <Link href="https://santos.lol/" target='_blank'><Globe className='w-' size={24} /></Link>
        </div>
        <div className="border border-purple-500 rounded-lg md:px-5 md:py-6 px-8 py-12">
          <Image
            src="/edgar.jpg"
            ...
            className='rounded-full  mb-3'
          />
          <h2 className='block mb-2 font-bold md:text-md text-xl'>Edgar Saravia</h2>
          <p className='block mb-3'>Builder</p>
          <Link href="https://github.com/EdgarAllan07" target='_blank'><Globe className='w-' size={24} /></Link>
        </div>
      </div>
    </main>
  )
